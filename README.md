...
| **Right-click a vault item** | **Open its action menu** (open · copy user/pass/TOTP · edit · move · favorite · delete) |
...
MOUSE
  ...
  Right-click a vault item · action menu (open/copy/edit/move/favorite/delete)
```
